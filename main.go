...
type Photo struct {
	...
	PhotographerUel string      `json:"photographer_url"`
...
type Video struct {
	...
	FullRes       interface{}     `json:"fullRes"`
...
type VideoPictures struct {
	Id           int32  `json:"id"`
	VideoPicture string `json:"videoPicture"`
	Nr           int32  `json:"nr"`
}
...
func main() {
	os.Setenv("PexelsToken", "7mpGVGT3KnoiOJdE0wuQ4lMPmbGSz9CScO1MMoIKrIWUx4BEMgVFubmA")
